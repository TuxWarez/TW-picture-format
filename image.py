    ...
    for j in range(int(width/8)) :
        ...
        for k in range(8):
            ...
            if not isinstance(value, int):
                if abs(background[0] - value[0]) < abs(foreground[0] - value[0]) and abs(background[1] - value[1]) < abs(foreground[1] - value[1]) and abs(background[2] - value[2]) < abs(foreground[2] - value[2]):
                    value = 0
                else:
                    value = 1
            else:
