...
print(f"Resolution: {width*8}x{height}; Background: #{byte_list[3]:02x}{byte_list[4]:02x}{byte_list[5]:02x}; Foreground: #{byte_list[6]:02x}{byte_list[7]:02x}{byte_list[8]:02x}; size: {int(len(byte_list)/1024)}kb")
